...
//General Methods
  ...
  void ComOpen(_In_z_ LPCTSTR pszPort, _In_ DCB &dcb, _In_ BOOL bOverlapped = FALSE);

  void ComOpen(_In_z_ LPCTSTR pszPort, _In_ DWORD dwBaud = 9600, _In_ Parity parity = NoParity, _In_ BYTE DataBits = 8,
            _In_ StopBits stopBits = OneStopBit, _In_ FlowControl fc = NoFlowControl, _In_ BOOL bOverlapped = FALSE);
  void Close();
...
//Reading / Writing Methods
  ...
  void  CancelIo();
  DWORD BytesWaiting();  // == BytesAvailable()
